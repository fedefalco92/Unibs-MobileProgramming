...
import it.unibs.appwow.fragments.AmountsFragment.OnListFragmentInteractionListener;
...
public class AmountRecyclerViewAdapter extends RecyclerView.Adapter<AmountRecyclerViewAdapter.ViewHolder> {
    ...
    public AmountRecyclerViewAdapter(List<Amount> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
